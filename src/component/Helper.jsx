...
//this function converts  wind directions given in degrees
...
//this function converts meteres to kilometers 
export const getVisibilityValue = (visibility) => {
    const km = visibility / 1000;
    return '$(km.toFixed(1)) km';
};

//this function convert temaprature celsius to farehnhit upto 1 decimal

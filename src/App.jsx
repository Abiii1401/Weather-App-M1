...
const App = () => {
  ...
  // FETCHES 5 LOCATIONS SUGGESTIONS FROM APT AND UPDATES
  ...
  //this function prevents form submission validate city and fetches data
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="bg-blue-400 hover:bg-blue-700 text-white font-semibold py-1 px-3 rounded transition-colors"
                >
                  &deg;{unit}
                </button>
              </div>
